...
import { TeamsEventsProvider } from "../../src/dal/TeamsEventsProvider";
import { assert } from "chai";

describe("TeamsEventsProvider", () => {
    test("should get events from graph api", async () => {
        ...
        let teamsEventsProvider = new TeamsEventsProvider(context as any);
        let events = await teamsEventsProvider.getTeamsEvents("test-group-id");
